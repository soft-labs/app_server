/**
 * BusinessObject :: ItemIdentVeiculos
...
function ItemIdentVeiculos(){
    ...
    this.source = {
        ...
        metadata: {
            ...
            fields: {
                ...
                chassi: {
                    tipo: types.comp.text, label: 'Chassi:'
                }, 
                observacoes: {
    ...
    this.forms = {
        ...
        update:{
            ...
            linhas: [
                {titulo: "Informações de item_ident_veiculos"},
                {item_identificado_key: 25, placa: 25, chassi: 25, observacoes: 25}
            ],
            ctrls: {
                placa: {
    ...
    this.providers = {
        ...
        default: {
            sources: {
                0: {
                    from: ['dbms', 'items', 'item_ident_veiculos'],
                    fields: [
...
// Exporta
module.exports = ItemIdentVeiculos;