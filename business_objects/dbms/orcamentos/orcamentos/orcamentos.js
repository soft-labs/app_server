...
function Orcamentos(){
    ...
    this.source = {
        ...
        metadata: {
            ...
            fields: {
                ...
                ent_coligadas_key: {
                    tipo: types.comp.choose, label: 'Ent Coligadas:',
                    data: { 
                        key: ['ent_coligadas_key'], 
                        from: ['dbms', '', 'ent_coligadas'], 
                        template: '{ent_coligadas_key} - {ent_coligada}', 
                        provider: '' 
                    } 
                }, 
                descricao: {
                ...
                coligadas_key: {
                    tipo: types.comp.choose, label: 'Coligadas:',
                    data: { 
                        key: ['coligadas_key'], 
                        from: ['dbms', '', 'coligadas'], 
                        template: '{coligadas_key} - {coligada}', 
                        provider: '' 
                    } 
                }
            }
    ...
    this.providers = {
        ...
        default: {
            sources: {
                0: {
                    from: ['dbms', 'orcamentos', 'orcamentos'],
                    fields: [
