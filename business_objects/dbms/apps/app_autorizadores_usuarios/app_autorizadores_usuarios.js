/**
 * BusinessObject :: AppAutorizadoresUsuarios
...
function AppAutorizadoresUsuarios(){
    ...
    // Id
    this.id = 'app_autorizadores_usuarios';
    ...
    this.forms = {
        ...
        update:{
            ...
            linhas: [
                {titulo: "Informações de app_autorizadores_usuarios"},
                {app_autorizadores_key: 25, sec_usuarios_key: 25, ativo: 50}
            ],
            ctrls: {
    ...
    this.providers = {
        ...
        default: {
            sources: {
                0: {
                    from: ['dbms', 'apps', 'app_autorizadores_usuarios'],
                    fields: [
...
// Exporta
module.exports = AppAutorizadoresUsuarios;