/**
 * BusinessObject :: AppAutorizadores
...
function AppAutorizadores(){
    ...
    this.source = {
        ...
        metadata: {
            ...
            fields: {
                ...
                autorizadores: {
                    tipo: types.comp.text, label: 'Autorizadores:'
                }, 
                observacoes: {
    ...
    this.forms = {
        ...
        update:{
            ...
            linhas: [
                {titulo: "Informações de app_autorizadores"},
                {app_autorizadores_key: 25, ativo: 25, autorizadores: 25, observacoes: 25}
            ],
            ctrls: {
                autorizadores: {
    ...
    this.providers = {
        ...
        default: {
            sources: {
                0: {
                    from: ['dbms', 'apps', 'app_autorizadores'],
                    fields: [
...
// Exporta
module.exports = AppAutorizadores;