/**
 * BusinessObject :: MovTiposCategorias
...
function MovTiposCategorias(){
    ...
    // Id
    this.id = 'mov_tipos_categorias';

    // Map
    this.source = {
        table: 'mov_tipos_categorias',
        metadata: {
            key: 'mov_tipos_categorias_key',
            label: 'tipos_categoria',
            fields: {
    ...
    this.providers = {
        ...
        default: {
            ...
            where: [ 
                ['AND', 0, 'mov_tipos_categorias_key', types.where.check]
            ],
            order: [
...
// Exporta
module.exports = MovTiposCategorias;