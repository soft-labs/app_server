    ...
    this.forms = {
        ...
        update:{
            ...
            linhas: [
                ...
                {sec_regras_key: 25, sec_regras_categ_key: 25, ativo: 25, codigo: 25}, 
                {regra: 25, observacoes: 75}
            ],
            ctrls: {
                regra: {
