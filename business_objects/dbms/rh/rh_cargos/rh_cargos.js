...
function RhCargos(){
    ...
    this.forms = {
        ...
        update:{
            ...
            linhas: [
                {titulo: "Informações de rh_cargos"},
                {rh_cargos_key: 25, cont_centro_resultados_key: 25, cargo: 25, remuneracao_min: 25}, 
                {remuneracao_max: 25, observacoes: 75}
            ],
            ctrls: {
                cargo: {
    ...
    this.providers = {
        ...
        default: {
            ...
            search: [
                    {alias: 0, field: 'cargo',  param: types.search.like_full }
            ],
            limit: 250,
            showSQL: 0
        },
