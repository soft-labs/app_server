/**
 * BusinessObject :: DreamCategorias
 *  Implementação de objeto de negócio: dream_categorias.
 *
 * Engine de aplicações - TShark.
 * @since Fri Jun 17 2016 15:44:50 GMT-0300 (BRT)
 * @constructor
 */
function DreamCategorias(){

    //region :: Definições do Objeto

    // Id
    this.id = 'dream_categorias';

    // Map
    this.source = {
        table: 'dream_categorias',
        metadata: {
            key: 'dream_categorias_key',
            label: 'category',
            fields: {
                dream_categorias_key: {
                    tipo: types.comp.key, label: 'Categoria:'
                },
                _active: {
    ...
    this.forms = {
        ...
        update:{
            ...
            linhas: [
                ...
                {_active: 15, num_order: 15, category: 70},
                {img_category: 100}
            ],
            ctrls: {
    ...
    this.providers = {
        ...
        default: {
            ...
            search: [
                {alias: 0, field: 'category',  param: types.search.like_full },
            ],
            limit: 250,
            showSQL: 0
        },
...
// Exporta
module.exports = DreamCategorias;