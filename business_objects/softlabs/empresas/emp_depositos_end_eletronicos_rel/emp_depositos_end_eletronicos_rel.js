/**
 * BusinessObject :: EmpDepositosEndEletronicosRel
...
function EmpDepositosEndEletronicosRel(){
    ...
    // Id
    this.id = 'emp_depositos_end_eletronicos_rel';

    // Map
    this.source = {
        table: 'emp_depositos_end_eletronicos_rel',
        metadata: {
            key: ['emp_depositos_key', 'end_eletronicos_key'],
            label: '',
            fields: {
                emp_depositos_key: {
    ...
    this.forms = {
        ...
        update:{
            ...
            linhas: [
                {titulo: "Informações de emp_depositos_end_eletronicos_rel"},
                {emp_depositos_key: 25, end_eletronicos_key: 75}
            ],
            ctrls: {
    ...
    this.providers = {
        ...
        default: {
            sources: {
                0: {
                    from: ['softlabs', 'empresas', 'emp_depositos_end_eletronicos_rel'],
                    fields: [
...
// Exporta
module.exports = EmpDepositosEndEletronicosRel;