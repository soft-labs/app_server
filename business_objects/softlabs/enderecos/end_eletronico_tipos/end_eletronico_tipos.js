/**
 * BusinessObject :: EndEletronicoTipos
 *  Implementação de objeto de negócio: end_eletronico_tipos.
 *
 * Engine de aplicações - TShark.
 * @since Mon May 16 2016 10:46:29 GMT-0300 (BRT)
 * @constructor
 */
function EndEletronicoTipos(){

    //region :: Definições do Objeto

    // Id
    this.id = 'end_eletronico_tipos';

    // Map
    this.source = {
        table: 'end_eletronico_tipos',
        metadata: {
    ...
    this.providers = {
        ...
        default: {
            ...
            where: [ 
                ['AND', 0, 'end_eletronico_tipos_key', types.where.check]
            ],
            order: [
                [0, 'tipo', 'asc']
            ],
...
// Exporta
module.exports = EndEletronicoTipos;