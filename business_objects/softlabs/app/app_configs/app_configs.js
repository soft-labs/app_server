...
function AppConfigs(){
    ...
    this.source = {
        ...
        metadata: {
            ...
            fields: {
                ...
                code: {
                    tipo: types.comp.text, label: 'Code:'
                }, 
                config: {
                ...
                fields: {
                    tipo: types.comp.text_big, label: 'Fields:'
                }, 
                observacoes: {
    ...
    this.forms = {
        ...
        update:{
            ...
            linhas: [
                {titulo: "Informações de app_configs"},
                {app_configs_key: 25, code: 25, config: 25, valor: 25}, 
                {fields: 25, observacoes: 75}
            ],
            ctrls: {
                config: {
    ...
    this.providers = {
        ...
        default: {
            ...
            where: [ 
                ['AND', 0, 'app_configs_key', types.where.check]
            ],
            order: [
                [0, 'config', 'asc']
            ],
