...
function ItemModelos(){
    ...
    this.source = {
        ...
        metadata: {
            ...
            fields: {
                item_modelos_key: {
                    tipo: types.comp.key, label: 'Item Modelos:'
                }, 
                item_marcas_key: {
    ...
    this.forms = {
        ...
        update:{
            ...
            linhas: [
                {titulo: "Informações de item_modelos"},
                {item_modelos_key: 25, item_marcas_key: 25, modelo: 50}
            ],
            ctrls: {
                modelo: {
    ...
    this.providers = {
        ...
        default: {
            ...
            where: [ 
                ['AND', 0, 'item_modelos_key', types.where.check]
            ],
            order: [
                [0, 'modelo', 'asc']
            ],
