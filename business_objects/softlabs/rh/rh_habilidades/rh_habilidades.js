...
function RhHabilidades(){
    ...
    this.source = {
        ...
        metadata: {
            ...
            fields: {
                ...
                habilidade: {
                    tipo: types.comp.text, label: 'Habilidade:'
                }, 
                observacoes: {
    ...
    this.forms = {
        ...
        update:{
            ...
            linhas: [
                {titulo: "Informações de rh_habilidades"},
                {rh_habilidades_key: 25, codigo: 25, habilidade: 25, observacoes: 25}
            ],
            ctrls: {
                habilidade: {
