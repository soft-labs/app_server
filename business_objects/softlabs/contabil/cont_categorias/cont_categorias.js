...
function ContCategorias(){
    ...
    this.providers = {
        ...
        default: {
            ...
            where: [ 
                ['AND', 0, 'cont_categorias_key', types.where.check]
            ],
            order: [
                [0, 'cont_categoria', 'asc']
            ],
            search: [
                    {alias: 1, field: 'cont_categoria',  param: types.search.like_full }
            ],
            limit: 250,
            showSQL: 0
        },
