...
function ContDreConfig(){
    ...
    this.source = {
        ...
        metadata: {
            ...
            fields: {
                ...
                agrupador: {
                    tipo: types.comp.text, label: 'Agrupador:'
                }, 
                observacoes: {
    ...
    this.forms = {
        ...
        update:{
            ...
            linhas: [
                {titulo: "Informações de cont_dre_config"},
                {cont_dre_config_key: 25, ordem: 25, agrupador: 25, observacoes: 25}
            ],
            ctrls: {
                agrupador: {
    ...
    this.providers = {
        ...
        default: {
            ...
            search: [
                    {alias: 7, field: 'agrupador',  param: types.search.like_full }
            ],
            limit: 250,
            showSQL: 0
        },
